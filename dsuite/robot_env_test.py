...
from dsuite.robot_env import RobotEnv
from dsuite.utils.testing.mock_sim_scene import patch_sim_scene
...
class TestEnv(RobotEnv):
    ...
    def __init__(self, nq=1, **kwargs):
        ...
        with patch_sim_scene('dsuite.robot_env.SimScene', nq=nq):
...
class RobotEnvTest(unittest.TestCase):
    ...
    def test_step_dict(self):
        ...
        self.assertListEqual(list(obs.keys()), ['o1', 'o2'])
    ...
    def test_get_obs_subset_dict(self):
        ...
        obs = test._get_obs()
        self.assertListEqual(list(obs.keys()), ['b', 'd'])
