...
class SimRandomizer:
    ...
    def __init__(self, sim_scene: SimScene,
                 random_state: np.random.RandomState):
        """Initializes a new randomizer.

        Args:
            sim_scene: The simulation to randomize.
            random_state: The random state to use to generate randomness.
        """
        self.sim_scene = sim_scene
        self.rand = random_state
        self.model = sim_scene.model
        self.orig_model = sim_scene.copy_model()
